...
describe('ClinchTalent', function () {
  ...
  describe('should make appropriate requests', function () {
    ...
    it('#getTheme()', function () {
      var mock = sinon.mock(request);
      var expectedHeaders = {headers: {Accept: 'application/vnd.api+json', Authorization: 'APIAuth YOUR-KEY:xswV13clrzrVKzEgZufsF25TsiY=', Date: 'Thu, 01 Jan 1970 00:00:00 GMT'}};
    ...
    it('#getPageLayouts()', function () {
      var mock = sinon.mock(request);
      var expectedHeaders = {headers: {Accept: 'application/vnd.api+json', Authorization: 'APIAuth YOUR-KEY:1E0D1A88RMrlJQjc9OrCvzWcZX0=', Date: 'Thu, 01 Jan 1970 00:00:00 GMT'}};
    ...
    it('#getPageLayout()', function () {
      var mock = sinon.mock(request);
      var expectedHeaders = {headers: {Accept: 'application/vnd.api+json', Authorization: 'APIAuth YOUR-KEY:RRVWkOsSzoOHPwiR9BHmmoVNQEE=', Date: 'Thu, 01 Jan 1970 00:00:00 GMT'}};
    ...
    it('#patchPageLayout()', function () {
      var mock = sinon.mock(request);
      var expectedHeaders = {headers: {Accept: 'application/vnd.api+json', Authorization: 'APIAuth YOUR-KEY:RRVWkOsSzoOHPwiR9BHmmoVNQEE=', Date: 'Thu, 01 Jan 1970 00:00:00 GMT'}, body: {html: '<html></html>'}, json: true};
