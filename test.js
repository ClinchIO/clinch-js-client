...
describe('ClinchTalent', function () {
  ...
  describe('should make appropriate requests', function () {
    ...
    it('#patchPageLayout()', function () {
      var mock = sinon.mock(request);
      var expectedHeaders = {headers: {Accept: 'application/vnd.api+json', Authorization: 'APIAuth YOUR-KEY:OBGOKGl+AcMMzlI1r5QixDg+Ypo=', Date: 'Thu, 01 Jan 1970 00:00:00 GMT'}, body: {html: '<html></html>'}, json: true};
